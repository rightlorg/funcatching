...
Server::Server(QWidget *parent, QTcpSocket *socket, qint64 totalMapNumT) :
	QDialog(parent),
	ui(new Ui::Server)
{
...
void Server::updateServerProgress()
{
	...
	if(socketConnection->bytesAvailable() < (totalBytes - sizeof(qint64) * 2 - fileNameSize)) return;
	inBlock = socketConnection->read(totalBytes - sizeof(qint64) * 2 - fileNameSize);
